...
@Injectable({
  providedIn: 'root',
  /**
   * Because LoggerService and Experimental Logger service implement the same interface, you can use useClass to specify
   ...
   * useValue can be used to create a dependency from an object literal.The object literal must match
